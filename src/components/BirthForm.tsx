  ...
  return (
    <>
      <motion.form
        ...
        className={`w-full max-w-xl mx-auto space-y-4 md:space-y-6 ${transparentBackground ? '' : 'sm:bg-white/[0.03] p-4 md:p-8 rounded-[1.5rem] md:rounded-[3rem] border-white/5 sm:backdrop-blur-xl transition-all'}`}
      >
